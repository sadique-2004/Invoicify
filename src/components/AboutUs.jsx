    ...
    <div className="bg-white text-gray-800 min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 space-y-12">
        ...
        <div className="py-8 text-center">
          ...
          {/* <Link to="/login"> */}
          <button className="mt-4 px-6 py-3 bg-[#45ccb8] text-white rounded-md hover:bg-white hover:text-[#45ccb8] font-oswald" onClick={getStarted}>
            Get Started Now
          </button>
          {/* </Link> */}
        </div>
        ...
        <div className="space-y-12 mt-8">
          <h3 className="text-3xl font-semibold text-[#45ccb8] text-center font-playfair-display">Meet the Creator</h3>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center text-center gap-8">
            <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg">
              ...
              />
              <h4 className="text-xl font-semibold text-[#45ccb8]">Mohammad Sadique</h4>
              <p className="text-gray-600">Founder, Developer, and Creator of Invoicify</p>
              <p className="mt-4 text-gray-600 font-merriweather">Empowering small businesses and streamlining processes is my passion. I'm Md Sadique, the creator of Invoicify—a tool designed to make invoicing effortless, efficient, and completely <span className="bg-yellow-500 px-2">FREE</span> 🎁 for everyone!</p>
              <div className="mt-4">
                <p className="font-semibold">Connect with Me  🤝</p>
                <div className="flex space-x-4 mt-2 justify-center">
                  <a href="https://www.linkedin.com/in/mdsadique5" target="_blank" rel="noopener noreferrer" className="text-[#45ccb8] hover:text-[#DD8788]">
                    LinkedIn
                  </a>
                  <a href="https://linktr.ee/Md_Sadique2004" target="_blank" rel="noopener noreferrer" className="text-[#45ccb8] hover:text-[#DD8788]">
                    Linktree
                  </a>
                </div>
              </div>
